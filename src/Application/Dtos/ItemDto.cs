...
internal sealed class ItemDtoMappingProfile : Profile
{
    public ItemDtoMappingProfile()
    {
        CreateMap<Item, ItemDto>()
            ...
            .ForMember(x => x.DisplayName, opt => opt.MapFrom(x => $"{x.Quality.DisplayName} {x.ItemType.Name}"))
            .ForMember(x => x.ItemTypeId, opt => opt.MapFrom(x => x.ItemType.Id))
            .ForMember(x => x.Description, opt => opt.MapFrom(x => x.ItemType.Description))
            ...
            .ForMember(x => x.Image, opt => opt.MapFrom(x => x.ItemType.Image))
            .ForMember(x => x.Rarity, opt => opt.MapFrom(x => x.ItemType.Rarity))
