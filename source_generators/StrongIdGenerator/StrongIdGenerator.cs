...
public sealed class StrongIdGenerator : IIncrementalGenerator
{
    ...
    {
        context.AddSource("Ruby.Generated.StrongIdHelper.g.cs", StrongIdHelperSourceCode);
        context.AddSource("Ruby.Generated.StrongIdAttribute.g.cs", StrongIdAttributeSourceCode);
    }
    ...
    private static (INamedTypeSymbol EntityType, INamedTypeSymbol IdType)? SemanticTransform(GeneratorSyntaxContext context, CancellationToken ct)
    {
        ...
        {
            var strongIdAttribute = context.SemanticModel.Compilation.GetTypeByMetadataName("Ruby.Generated.StrongIdAttribute");
    ...
    private static void Execute(SourceProductionContext context, EntityStrongIdContext subject)
    {
        ...
        var idSource = $$"""
                         ...
                         """;
        context.AddSource($"Ruby.Generated.{qualifiedName}Id.g.cs", idSource);
        ...
        var jsonConverterSource = $$"""
                                    ...
                                    """;
        context.AddSource($"Ruby.Generated.{qualifiedName}JsonIdConverter.g.cs", jsonConverterSource);
        ...
        var efCoreConverterSource = $"""
                                 ...
                                 """;
        context.AddSource($"Ruby.Generated.{qualifiedName}EfCoreIdConverter.g.cs", efCoreConverterSource);
        ...
        var idConverterEfCoreExtSource = $$"""
                                           ...
                                           """;
        context.AddSource($"Ruby.Generated.{qualifiedName}IdConventionExt.g.cs", idConverterEfCoreExtSource);
    }
}